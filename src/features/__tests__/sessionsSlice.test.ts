            ...
            const sessions = new SessionsBuilder()
                .withSession(
                    new SessionBuilder()
                        ...
                        .withAttendee(new AttendeeBuilder().id("1").firstname("Laurent").lastname("Gas").checkedIn().credits(5).build())
        ...
        it("should decrease client credits", async () => {
            ...
            const sessions = new SessionsBuilder()
                ...
                .withSession(
                    new SessionBuilder().withId("2").withClassroom("1").withName('Pilates Trio')
                        ...
                        .withAttendee(new AttendeeBuilder().id("1").firstname("Laurent").lastname("Gas").credits(5).build())
                        .withAttendee(new AttendeeBuilder().id("2").firstname("Pierre").lastname("Bernard").noCredits().build())
                        .build()
                )
                .withSession(
                    new SessionBuilder().withId("3").withClassroom("3").withName('Pilates avancé')
                        ...
                        .withAttendee(new AttendeeBuilder().id("1").firstname("Laurent").lastname("Gas").credits(8).build())
                        .build()
                )
                .withSession(
            ...
            const action = new FulFilledAction(sessionCheckin)
                .withPayload(
                    new SessionBuilder().withId("2").withClassroom("1").withName('Pilates Trio')
                        .withMachineTrio().withScheduleAsString(formatISO(addWeeks(currentDate, 1))).withPosition(3)
                        .withAttendee(new AttendeeBuilder().id("1").firstname("Laurent").lastname("Gas").checkedIn().credits(4).build())
                        .withAttendee(new AttendeeBuilder().id("2").firstname("Pierre").lastname("Bernard").noCredits().build())
                    .build())
                .build()
                ...
                sessions: [
                    {
                        ...
                        schedule: {
                            ...
                            stop: format(addHours(currentDate, 1), "yyyy-MM-dd'T'HH:mm:ssXXX")
                        },
                        position: 3,
                        attendees: [
                            {
                    ...
                    },
                    {
                        ...
                        name: "Pilates Trio",
                        schedule: {
                            start: format(addWeeks(currentDate, 1), "yyyy-MM-dd'T'HH:mm:ssXXX"),
                            stop: format(addHours(addWeeks(currentDate, 1), 1), "yyyy-MM-dd'T'HH:mm:ssXXX")
                        },
                        position: 3,
                        attendees: [
                            {
                    ...
                    },
                    {
                        ...
                        name: "Pilates avancé",
                        schedule: {
                            start: format(addHours(currentDate, 2), "yyyy-MM-dd'T'HH:mm:ssXXX"),
                            stop: format(addHours(currentDate, 3), "yyyy-MM-dd'T'HH:mm:ssXXX")
                        },
                        position: 2,
                        attendees: [
                            {
                    ...
                    },
                    {
                        ...
                        schedule: {
                            start: format(subDays(currentDate, 2), "yyyy-MM-dd'T'HH:mm:ssXXX"),
                            stop: format(addHours(subDays(currentDate, 2), 1), "yyyy-MM-dd'T'HH:mm:ssXXX")
                        },
                        position: 3,
                        attendees: [
                            {
