...
describe('Create Client', () => {
    ...
    it("add credits should be disabled hence all subjects are set", async () => {
        ...
        expect(machineDuo.getAllByRole("option").map(item => item.textContent)).toEqual(["Machine Duo", "Machine Trio", "Machine private"])
        ...
        expect(machineTrio.getAllByRole("option").map(item => item.textContent)).toEqual(["Machine Trio", "Machine private"])
        ...
        expect(machinePrivate.getAllByRole("option").map(item => item.textContent)).toEqual(["Machine private"])
    ...
    it("should clean all hence submitted", async () => {
        ...
        expect(screen.queryByText("10", {selector: 'span'})).not.toBeInTheDocument()
        expect(screen.queryByText(/mat/i, {selector: 'p'})).not.toBeInTheDocument()
        expect(screen.queryByText(/machine duo/i, {selector: 'p'})).not.toBeInTheDocument()
    })
})